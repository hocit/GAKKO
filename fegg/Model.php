...
class Model
{
    ...
    {
        $this->_model_having->openBracket();
    ...
    {
        $this->_db->create($this->_table, $fields)->execute();
    }
     ...
     * Execute Alter
     */
    public function alterAddColumn($option, $field)
    {
        $this->_db->alterAddColumn($this->_table, $field)->execute();
    }
    public function alterRenameTo($option, $rename)
    {
    ...
    {
        return $this->_db->pragma($table, $mode)->execute()->all();;
    }
