...
class Contact2 extends MyApplication
{
    private $_common;
    ...
    public function __construct()
    {
        ...
        $this->contact_config =
            require(FEGG_CODE_DIR.'/config/contact/contact2_config.php');
    }
    ...
    public function post()
    {
        ...
        $cli_mail    = new Mail('【'.$this->page['data']['parent_name'].'】' . $cli_subject, $cli_body);
