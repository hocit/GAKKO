...
<section class="secBasic01 secBasic01school">
    <div class="container">
        <div class="txt">
            <h1 class="title">教室事業</h1>
...
<section class="secBasic03">
    <div class="container">
        <div class="list">
            ...
            <div class="item">スクール事業</div>
        </div>
    </div>
</section>

<section class="secSchool01">
    <div class="container">
        <div class="txt">
            <div class="title">
...
この2つの事業をミックスさせ、これまでにないまったく新しい学び空間『LIBRETTO SCHOOL』を創り出します。<br>
ここでは、東海地方初開校となる『陰山式スコーラ』をさらにブラッシュアップした『陰山式スコーラプレミア』や、これも東海地方初開校となる、大手鉄道会社が手掛ける信頼のロボットプログラミング教室『プログラボ』、日本で初めてフォニックスルールを提唱し、四技能の先駆けとなった英語出版社、mpi松香フォニックスによる『mpi英語倶楽部』など、これまでにない新しい学びをご提供します。<br>
物販コーナーでは、著名な先生が推薦する図書や文具、安心できる上質の雑貨など、ワンランク上の品物を取り揃えて、お子様にとって必ずプラスになるようなものを厳選して販売します。<br>
また、教室に隣接して学習情報スペースも設けます。ここでは、各学校のカタログを陳列したり、各スクールに通うお子様の保護者様同士での交流の場としても活用いただけます。</div>
        </div>
    </div>
</section>

<section class="secSchool02 secSchool02aa">
</section>

<section class="secSchool03 secSchool03aa">
    <div class="container">
        <div class="txt">
            <h2 class="title">
                陰山式スコーラプレミア
            ...
            <div class="subtitle">
                『陰山式スコーラプレミア』は、百ます計算による脳の高速化、ハイレベルな音読指導による脳の活性化、
                そしてそれらの力を土台に各テキストの学習に取り組み、徹底反復によって脳力を鍛え、記憶力を強化し、 学力の基礎基本を高いレベルまで押し上げます。す。
            </div>
        </div>
        <div class="list">
...
<section class="secSchool02 secSchool02ab">
</section>

<section class="secSchool03 secSchool03ab">
    <div class="container">
        <div class="txt">
            <h2 class="title">
                mpi英語倶楽部
            </h2>
            <div class="subtitle">英語教育の老舗mpi松香フォニックスが監修する、大人のための英語教室『mpi英語倶楽部』。<br>
言語の学習は英語力だけでなく、健康にも大変効果的なのをご存じでしょうか。<br>
言語を学習すると脳が活性化されます。普段日常生活で使用しない言語である英語を使ってものを考えたり、英語を聞いたり、英語を話したり。これらすべてが健康にもつながっているのです。<br>
mpi英語倶楽部は、英語力はもちろんのこと、皆様の生活をより豊かに健康にいたします。<br>
英語のプロが選んだ教材と、優秀な講師陣が皆様をお迎えします。<br>
また、オプションでは、海外研修のプログラムもご用意しています。<br>
※新型コロナ収束まではオンラインとなる予定です。</div>
        </div>
        <div class="list">
            <a href="" class="item">
                <figure class="img">
...
<section class="secSchool02 secSchool02ac">
</section>

<section class="secSchool03 secSchool03ac">
    <div class="container">
        <div class="txt">
            <h2 class="title">
                プログラボ
            </h2>
            <div class="subtitle">ICTの進歩、デジタル化の加速、AIの導入…リアルとネットの融合が進む変化の激しい時代では、これから十数年で半数近くの職業が機械に置き換わるともいわれています。<br>
そんな中、人が機械に強みを持てる部分は、“考えること”です。<br>
未来を生きる子どもたちには、「与えられた問いに正しい答えを出す力」よりも、「自ら課題を見つけ、解決できる力」こそが求められているのです。<br>
そんな中、ロボットプログラミング教育を通じて「考え方」「生き方」「課題発見力」「課題解決力」を学び養える場として誕生したのが、『プログラボ』です。</div></div>
        <div class="list">
            <a href="" class="item">
                <figure class="img">
        ...
        <div class="row">
            <div class="col01">
                <div class="txt">
                    ...
                    <div class="subtitle">大人の『日本画講座』<br>
なにか趣味を持ちたいけど、なかなかよさそうなものが見つからない。<br>
日本画って、少しとっつきづらい。そんな感想をお持ちではないでしょうか。<br>
本講座では、日本画家 小沢英之先生による、初心者からでもできる日本画の講座です。<br>
どなたでも、お気軽に参加いただけます。<br>
この機会に、ぜひ日本画の魅力に触れてみてはいかがでしょうか。<br>
<span>講師：小沢英之氏　日本画家・社団法人HOPE理事長・前 静岡大学情報科学技術院 客員教授</span></div>
    ...
    <div class="container">
        ...
        <div class="list">
            ...
            <a href="{{ base }}/school/news/detail_{{ $post[ $page.id ] }}.html" class="item">
                ...
                {{ end }}
                {{ code $title = feggExcerpt45($post.title) }}
            ...
            <div class="col01">
                <div class="list">
                    <div class="item">
                        ...
                        <div class="title">
                            密を避けるため、1回の授業における最大人数は5～6名とします。
                        </div>
                    </div>
                    <div class="item">
                        <div class="order">2.</div>
                        <div class="title">
                            入室時の検温を徹底し、37.5℃以上ある講師・職員・生徒は入室をお断りします。
                        </div>
                    </div>
                    <div class="item">
                        <div class="order">3.</div>
                        <div class="title">
                            1授業終了毎に机・椅子等の消毒を行います。
