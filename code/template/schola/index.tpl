{{ assign $site.title = '陰山式スコーラプレミアについて | 教室事業 | 株式会社学校良品' }}
{{ assign $site.description = '学校良品の教室事業、陰山式スコーラプレミアは脳を効果的に使うトレーニングです。' }}
...
<section class="secBasic01 secBasic01schola">
    <div class="container">
        <div class="txt">
            <h1 class="title">陰山式スコーラプレミアについて</h1>
            <div class="subtitle">ABOUT SCHOLA</div>
        </div>
    </div>
</section>
...
<section class="secBasic03">
    <div class="container">
        <div class="list">
            ...
            <div class="item">陰山式スコーラプレミアについて</div>
        </div>
    </div>
</section>

<section class="secSchola01 secSchola01aa">
    <h2 class="title">
        陰山式スコーラプレミアとは
    </h2>
</section>

<section class="secSchola02 secSchola02aa">
    <div class="container">
        <div class="row">
            <div class="col01">
                <div class="txt txtLeft">
                    <h3 class="title">勉強とは、
脳を効果的に使うトレーニングです</h3>
                    <div class="subtitle">『陰山式スコーラプレミア』では、脳を活性化させ集中力と学力を高めていきます。
そして、できるという実感から学習への積極性を生み出します。</div>
                </div>
            </div>
            <div class="col02">
                <img src="{{ base }}/data/img/img41@2x.png" alt="" class="img imgLeft">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row rowReverse">
            <div class="col01">
                <div class="txt txtRight">
                    <h3 class="title">考える子どもを育て、
難関大に合格できる力をつける</h3>
                    <div class="subtitle">『陰山式スコーラプレミア』は、百ます計算による脳の高速化、ハイレベルな音読指導による脳の活性化、そしてそれらの力を土台に各テキストの学習に取り組み、徹底反復によって脳力を鍛え、記憶力を強化し、学力の基礎基本を高いレベルまで押し上げます。</div>
                </div>
            </div>
            <div class="col02">
                <img src="{{ base }}/data/img/img42@2x.png" alt="" class="img imgRight">
            </div>
        </div>
    </div>
</section>
...
<section class="secSchola02 secSchola02aa">
    <div class="container">
        <div class="row">
            <div class="col01">
                <div class="txt txtLeft">
                    <h3 class="title">学習の土台を作り上げる</h3>
                    <div class="subtitle">『陰山式スコーラプレミア』では、幼稚園年長～小学生のお子様を対象とします。なぜなら、その時期に早寝・早起き・朝ごはんといった生活習慣と共に、百ます計算や音読といった学習習慣をつけることで、その後の中学、高校での学習の土台を作り上げることができるからです。</div>
                </div>
            </div>
            <div class="col02">
                <img src="{{ base }}/data/img/img43@2x.png" alt="" class="img imgLeft">
            </div>
        </div>
    </div>
</section>
...
<section class="secSchola02 secSchola02aa">
    <div class="container">
        <div class="row rowReverse">
            <div class="col01">
                <div class="txt txtRight">
                    <h3 class="title">『脳力』のアップと基礎学力の向上</h3>
                    <div class="subtitle">１回の授業は、百ます計算、音読、漢字といった学習を50 分で行います。これを毎回徹底的に行うことで、脳の高速化（脳力のアップ）と基礎学力の向上を図ります。
幼稚園年長期や小学校低学年から、このような学習を徹底して行った結果、東大・京大・国立大医学部に入学できるような力を持った子どもを育てることができるのです。</div>
                </div>
            </div>
            <div class="col02">
                <img src="{{ base }}/data/img/img44@2x.png" alt="" class="img imgRight">
            </div>
        </div>
    </div>
</section>
...
<section class="secSchola03 secSchola03aa">
    <h2 class="title">
        アクセス
    </h2>
    <div class="subtitle">
            ...
            <div class="map">
                <svg xmlns="http://www.w3.org/2000/svg" width="5.2" height="7.399" viewBox="0 0 5.2 7.399">
                    <g id="arr" transform="translate(-331.255 -214.291)">
                        <path id="Path_44" data-name="Path 44" d="M9291.7,7842.992l4,3-4,3"
                            transform="translate(-8959.744 -7628.002)" fill="none" stroke="#356fbf"
