        ...
        <div class="row">
            <div class="col01">
                <div class="txt txtLeft">
                    <h3 class="title">勉強とは、
脳を効果的に使うトレーニングです</h3>
                    <div class="subtitle">『陰山式スコーラプレミア』では、脳を活性化させ集中力と学力を高めて
いきます。
...
難関大に合格できる力をつける</h3>
                    <div class="subtitle">『陰山式スコーラプレミア』は、百ます計算による脳の高速化、ハイレベ
ルな音読指導による脳の活性化、そしてそれらの力を土台に各テキストの
学習に取り組み、徹底反復によって脳力を鍛え、記憶力を強化し、学力の
基礎基本を高いレベルまで押し上げます。
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col01">
                <div class="txt txtLeft">
                    ...
                    <div class="subtitle">『陰山式スコーラプレミア』では、幼稚園年長～小学生のお子様を対象と
します。なぜなら、その時期に早寝・早起き・朝ごはんといった生活習慣
と共に、百ます計算や音読といった学習習慣をつけることで、その後の中
学、高校での学習の土台を作り上げることができるからです。</div>
                </div>
            </div>
            <div class="col02">
        ...
        <div class="row rowReverse">
            <div class="col01">
                <div class="txt txtRight">
                    ...
                    <div class="subtitle">１回の授業は、百ます計算、音読、漢字といった学習を50 分で行いま
す。これを毎回徹底的に行うことで、脳の高速化（脳力のアップ）と基礎
学力の向上を図ります。
幼稚園年長期や小学校低学年から、このような学習を徹底して行った結
果、東大・京大・国立大医学部に入学できるような力を持った子どもを育
てることができるのです。</div>
                </div>
            </div>
            <div class="col02">
