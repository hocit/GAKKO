...
class Date
{
    ...
    {
        // 年月日などの区切り記号[-,/]、時間の区切り記号[:]は任意
        // 日付と時間の間の空白は任意
        $pattern = array(
            '/^([0-9]{1,4})$/' => '$1-01-01 00:00:00',
            '/^([0-9]{1,4})[\-\/]*([0-9]{1,2})[\-\/]*$/' => '$1-$2-01 00:00:00',
            '/^([0-9]{1,4})[\-\/]*([0-9]{1,2})[\-\/]*([0-9]{1,2})\s*$/' => '$1-$2-$3 00:00:00',
            '/^([0-9]{1,4})[\-\/]*([0-9]{1,2})[\-\/]*([0-9]{1,2})\s*([0-9]{1,2})[\:]*$/' => '$1-$2-$3 $4:00:00',
            '/^([0-9]{1,4})[\-\/]*([0-9]{1,2})[\-\/]*([0-9]{1,2})\s*([0-9]{1,2})[\:]*([0-9]{1,2})[\:]*$/' => '$1-$2-$3 $4:$5:00',
            '/^([0-9]{1,4})[\-\/]*([0-9]{1,2})[\-\/]*([0-9]{1,2})\s*([0-9]{1,2})[\:]*([0-9]{1,2})[\:]*([0-9]{1,2})$/' => '$1-$2-$3 $4:$5:$6',
        );
